...
* replaced by this bundle's autoexec.sas (which stands up mock ADVS +
* metadata.t_vscat). share/macros/tfl_metadata.sas is inlined verbatim
...
* working directory. The categorical-summary logic is otherwise
* untouched.
*****************************************************************************/
