...
* replaced by this bundle's autoexec.sas (which stands up mock ADSL +
* metadata.t_pop). share/macros/tfl_metadata.sas is inlined verbatim
...
* working directory. Table logic is otherwise untouched.
\*****************************************************************************/
